...
public class InvalidPasswordClp extends BaseTest {

	public static final Logger logger = LogManager.getLogger(InvalidPasswordClp.class);
	DataFormatter formatter = new DataFormatter();
	LoginPage loginPage;

	public InvalidPasswordClp() {
	...
	public void invalidPasswordTwo() throws InterruptedException, IOException, TesseractException {
