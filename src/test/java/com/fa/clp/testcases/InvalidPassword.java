...
public class InvalidPassword extends BaseTest {
	...
	public static final Logger logger = LogManager.getLogger(InvalidPassword.class);
	...
	public void invalidPassword() throws InterruptedException, IOException, TesseractException {
		...
		try {
			...
			driver.findElement(By.cssSelector("#password")).sendKeys("newpas");
			do {
				/**
