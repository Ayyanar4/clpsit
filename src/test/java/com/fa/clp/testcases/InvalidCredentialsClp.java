...
public class InvalidCredentialsClp extends BaseTest {

	public static final Logger logger = LogManager.getLogger(InvalidCredentialsClp.class);
	DataFormatter formatter = new DataFormatter();
	LoginPage loginPage;

	public InvalidCredentialsClp() {
	...
	public void invalidCredentials() throws InterruptedException, IOException, TesseractException {
		...
		try {
			...
			driver.findElement(By.cssSelector("#password")).sendKeys("newpas121");
			do {
				/**
